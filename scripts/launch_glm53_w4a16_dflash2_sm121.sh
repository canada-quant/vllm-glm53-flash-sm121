...
# https://huggingface.co/canada-quant/GLM-5.3-Flash-DFlash2-G/blob/main/launch_dflash2_tp2.sh)
...
DRAFTER_HOST_PATH="${DRAFTER_HOST_PATH:-/models/GLM-5.3-Flash-DFlash2-G}"
