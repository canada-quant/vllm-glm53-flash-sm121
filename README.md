...
huggingface-cli download canada-quant/GLM-5.3-Flash-DFlash2-G --local-dir /models/GLM-5.3-Flash-DFlash2-G
...
| Weights | `canada-quant/GLM-5.3-Flash-W4A16-MTP` (target) + `canada-quant/GLM-5.3-Flash-DFlash2-G` (drafter; `-F` / `-E` still work: `DRAFTER_HOST_PATH=/models/GLM-5.3-Flash-DFlash2-F`) |
...
DRAFTER_HOST_PATH=/models/GLM-5.3-Flash-DFlash2-F bash launch_glm53_w4a16_dflash2_sm121.sh 1   # e.g. back to the previous release
```
